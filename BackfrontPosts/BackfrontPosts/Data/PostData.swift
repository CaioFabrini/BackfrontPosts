...
var PostData: [PostDataModel] = [
    ...
    PostDataModel(id: UUID(), profileImage: "youtubelogo", userName: "dheeraj.iosdev", location: nil, postImage: nil, dimensionImage: nil, isLiked: true, isSaved: true, likes: nil, caption: "Hi Guys! Today in design to code series I've come up with SwiftUI project hope it helps you!.", time: "2 hours ago", isSponsored: false, isVideo: true, dimensionVideo: Dimensions(width: 640, height: 636), videoUrl:"demo" , views: 1200),
    ...
    PostDataModel(id: UUID(), profileImage: "user2", userName: "dheeraj.iosdev", location: nil, postImage: "youtube-post", dimensionImage: nil, isLiked: true, isSaved: true, likes: nil, caption: "Hi Guys! Today in design to code series I've come up with SwiftUI project hope it helps you!.", time: "4 days ago", isSponsored: false, isVideo: true, dimensionVideo: Dimensions(width: 640, height: 640), videoUrl:"demo2" , views: 1200)
]
